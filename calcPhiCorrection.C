...
void calcPhiCorrection(){
  ...
  TH1F* h_pPbData = (TH1F*)f_pPbData->Get("hPhi");
  TH1F* h_ppData = (TH1F*)f_ppData->Get("hPhi");
  TH1F* h_pPbMC = (TH1F*)f_pPbMC->Get("hPhiW");
  TH1F* h_ppMC = (TH1F*)f_ppMC->Get("hPhiW");
  h_pPbData->Rebin(2);
  h_ppData->Rebin(2);
  h_pPbMC->Rebin(2);
  h_ppMC->Rebin(2);
  ...
  for(int i = 1; i < h_pPbData->GetNbinsX()+1; i++){
    Double_t dPhi = h_pPbData->GetBinWidth(i);

    Double_t content_pPbData = h_pPbData->GetBinContent(i);
    Double_t temp_pPbData = content_pPbData/(dPhi*numEvents_pPbData);
    Double_t error_pPbData  =  h_pPbData->GetBinError(i);
    Double_t tempE_pPbData = error_pPbData/(dPhi*numEvents_pPbData);
  ...
  h_pPbData->GetXaxis()->SetRangeUser(1, 3.5);
  h_pPbData->SetTitle("p-Pb;#phi;1/N_{eve} dN/d#phi");
  ...
  r_pPb->SetTitle("p-Pb;#phi;ratio (data/MC)");
  r_pPb->SetLineColor(kBlack);
  r_pPb->SetLineWidth(2);
  r_pPb->GetXaxis()->SetRangeUser(1, 3.5);
  ...
  h_ppData->GetXaxis()->SetRangeUser(1, 3.5);
  h_ppData->SetTitle("pp;#phi;1/N_{eve} dN/d#phi");
  ...
  //TH1F* r_pp = (TH1F*)h_ppData->Clone("r_pp");
  //r_pp->Divide(h_ppMC);
  r_pp->SetTitle("pp;#phi;ratio (data/MC)");
  r_pp->SetLineColor(kBlack);
  r_pp->SetLineWidth(2);
  r_pp->GetXaxis()->SetRangeUser(1, 3.5);
  ...
  printHistEntries(r_pPb);
  printHistEntries(r_pp);
  

  
  TFile* f_ppRun282366 = new TFile(Form("%scsOutput/ppOutput/Feb20AliPhysics/postQMNtuples/wEtaCorr/SMphiBin/RunByRun/fout_4_14bins_firstEvent0_17q_run282366_kMuonCalokCaloOnlykINT7_kNonLinCorr_latestEMCalCorr_rpaName_StdCuts_EX0PurityFit_wEtaCorr_SMphiBin_noNorm.root", path.Data()), "READ");
  TH1F* h_ppRun282366 = (TH1F*)f_ppRun282366->Get("hPhi");
  TH1D* n_ppRun282366 = (TH1D*)f_ppRun282366->Get("hNormalizer");
  h_ppRun282366->Rebin(2);
  TH1F* r_ppRun282366 = getRatio("r_ppRun282366", h_ppRun282366, h_ppMC, n_ppRun282366);

  TFile* f_ppRun282367 = new TFile(Form("%scsOutput/ppOutput/Feb20AliPhysics/postQMNtuples/wEtaCorr/SMphiBin/RunByRun/fout_4_14bins_firstEvent0_17q_run282367_kMuonCalokCaloOnlykINT7_kNonLinCorr_latestEMCalCorr_rpaName_StdCuts_EX0PurityFit_wEtaCorr_SMphiBin_noNorm.root", path.Data()), "READ");
  TH1F* h_ppRun282367 = (TH1F*)f_ppRun282367->Get("hPhi");
  TH1D* n_ppRun282367 = (TH1D*)f_ppRun282367->Get("hNormalizer");
  h_ppRun282367->Rebin(2);
  TH1F* r_ppRun282367 = getRatio("r_ppRun282367", h_ppRun282367, h_ppMC, n_ppRun282367);

  TFile* f_ppRun282391 = new TFile(Form("%scsOutput/ppOutput/Feb20AliPhysics/postQMNtuples/wEtaCorr/SMphiBin/RunByRun/fout_4_14bins_firstEvent0_17q_run282391_kMuonCalokCaloOnlykINT7_kNonLinCorr_latestEMCalCorr_rpaName_StdCuts_EX0PurityFit_wEtaCorr_SMphiBin_noNorm.root", path.Data()), "READ");
  TH1F* h_ppRun282391 = (TH1F*)f_ppRun282391->Get("hPhi");
  TH1D* n_ppRun282391 = (TH1D*)f_ppRun282391->Get("hNormalizer");
  h_ppRun282391->Rebin(2);
  TH1F* r_ppRun282391 = getRatio("r_ppRun282391", h_ppRun282391, h_ppMC, n_ppRun282391);

  TFile* f_ppRun282392 = new TFile(Form("%scsOutput/ppOutput/Feb20AliPhysics/postQMNtuples/wEtaCorr/SMphiBin/RunByRun/fout_4_14bins_firstEvent0_17q_run282392_kMuonCalokCaloOnlykINT7_kNonLinCorr_latestEMCalCorr_rpaName_StdCuts_EX0PurityFit_wEtaCorr_SMphiBin_noNorm.root", path.Data()), "READ");
  TH1F* h_ppRun282392 = (TH1F*)f_ppRun282392->Get("hPhi");
  TH1D* n_ppRun282392 = (TH1D*)f_ppRun282392->Get("hNormalizer");
  h_ppRun282392->Rebin(2);
  TH1F* r_ppRun282392 = getRatio("r_ppRun282392", h_ppRun282392, h_ppMC, n_ppRun282392);

  TFile* f_ppRun282398 = new TFile(Form("%scsOutput/ppOutput/Feb20AliPhysics/postQMNtuples/wEtaCorr/SMphiBin/RunByRun/fout_4_14bins_firstEvent0_17q_run282398_kMuonCalokCaloOnlykINT7_kNonLinCorr_latestEMCalCorr_rpaName_StdCuts_EX0PurityFit_wEtaCorr_SMphiBin_noNorm.root", path.Data()), "READ");
  TH1F* h_ppRun282398 = (TH1F*)f_ppRun282398->Get("hPhi");
  TH1D* n_ppRun282398 = (TH1D*)f_ppRun282398->Get("hNormalizer");
  h_ppRun282398->Rebin(2);
  TH1F* r_ppRun282398 = getRatio("r_ppRun282398", h_ppRun282398, h_ppMC, n_ppRun282398);

  TFile* f_ppRun282399 = new TFile(Form("%scsOutput/ppOutput/Feb20AliPhysics/postQMNtuples/wEtaCorr/SMphiBin/RunByRun/fout_4_14bins_firstEvent0_17q_run282399_kMuonCalokCaloOnlykINT7_kNonLinCorr_latestEMCalCorr_rpaName_StdCuts_EX0PurityFit_wEtaCorr_SMphiBin_noNorm.root", path.Data()), "READ");
  TH1F* h_ppRun282399 = (TH1F*)f_ppRun282399->Get("hPhi");
  TH1D* n_ppRun282399 = (TH1D*)f_ppRun282399->Get("hNormalizer");
  h_ppRun282399->Rebin(2);
  TH1F* r_ppRun282399 = getRatio("r_ppRun282399", h_ppRun282399, h_ppMC, n_ppRun282399);

  TFile* f_ppRun282402 = new TFile(Form("%scsOutput/ppOutput/Feb20AliPhysics/postQMNtuples/wEtaCorr/SMphiBin/RunByRun/fout_4_14bins_firstEvent0_17q_run282402_kMuonCalokCaloOnlykINT7_kNonLinCorr_latestEMCalCorr_rpaName_StdCuts_EX0PurityFit_wEtaCorr_SMphiBin_noNorm.root", path.Data()), "READ");
  TH1F* h_ppRun282402 = (TH1F*)f_ppRun282402->Get("hPhi");
  TH1D* n_ppRun282402 = (TH1D*)f_ppRun282402->Get("hNormalizer");
  h_ppRun282402->Rebin(2);
  TH1F* r_ppRun282402 = getRatio("r_ppRun282402", h_ppRun282402, h_ppMC, n_ppRun282402);

  TFile* f_ppRun282411 = new TFile(Form("%scsOutput/ppOutput/Feb20AliPhysics/postQMNtuples/wEtaCorr/SMphiBin/RunByRun/fout_4_14bins_firstEvent0_17q_run282411_kMuonCalokCaloOnlykINT7_kNonLinCorr_latestEMCalCorr_rpaName_StdCuts_EX0PurityFit_wEtaCorr_SMphiBin_noNorm.root", path.Data()), "READ");
  TH1F* h_ppRun282411 = (TH1F*)f_ppRun282411->Get("hPhi");
  TH1D* n_ppRun282411 = (TH1D*)f_ppRun282411->Get("hNormalizer");
  h_ppRun282411->Rebin(2);
  TH1F* r_ppRun282411 = getRatio("r_ppRun282411", h_ppRun282411, h_ppMC, n_ppRun282411);

  TFile* f_ppRun282415 = new TFile(Form("%scsOutput/ppOutput/Feb20AliPhysics/postQMNtuples/wEtaCorr/SMphiBin/RunByRun/fout_4_14bins_firstEvent0_17q_run282415_kMuonCalokCaloOnlykINT7_kNonLinCorr_latestEMCalCorr_rpaName_StdCuts_EX0PurityFit_wEtaCorr_SMphiBin_noNorm.root", path.Data()), "READ");
  TH1F* h_ppRun282415 = (TH1F*)f_ppRun282415->Get("hPhi");
  TH1D* n_ppRun282415 = (TH1D*)f_ppRun282415->Get("hNormalizer");
  h_ppRun282415->Rebin(2);
  TH1F* r_ppRun282415 = getRatio("r_ppRun282415", h_ppRun282415, h_ppMC, n_ppRun282415);

  TFile* f_ppRun282437 = new TFile(Form("%scsOutput/ppOutput/Feb20AliPhysics/postQMNtuples/wEtaCorr/SMphiBin/RunByRun/fout_4_14bins_firstEvent0_17q_run282437_kMuonCalokCaloOnlykINT7_kNonLinCorr_latestEMCalCorr_rpaName_StdCuts_EX0PurityFit_wEtaCorr_SMphiBin_noNorm.root", path.Data()), "READ");
  TH1F* h_ppRun282437 = (TH1F*)f_ppRun282437->Get("hPhi");
  TH1D* n_ppRun282437 = (TH1D*)f_ppRun282437->Get("hNormalizer");
  h_ppRun282437->Rebin(2);
  ...
  res_ppRun282366->SetTitle(";#phi;#frac{good pp - 1 run}{good pp}");
  res_ppRun282366->GetXaxis()->SetRangeUser(1, 3.5);
  res_ppRun282366->GetYaxis()->SetRangeUser(-1, 1);
  
  TCanvas* c_ppRes = new TCanvas("c_ppRes", "c_ppRes", 600, 600);
  res_ppRun282366->Draw("e1");
  ...
  TFile* f_pPb13d = new TFile(Form("%scsOutput/pPbOutput/Feb20AliPhysics/postQMNtuples/wEtaCorr/SMphiBin/PeriodByPeriod/fout_6_14bins_firstEvent0_13d_kEMCEGA_kINT7_kNonLinCorr_latestEMCalCorr_rpaName_StdCuts_EX0PurityFit_wEtaCorr_SMphiBinnoNorm.root", path.Data()), "READ");
  TH1F* h_pPb13d = (TH1F*)f_pPb13d->Get("hPhi");
  TH1D* n_pPb13d = (TH1D*)f_pPb13d->Get("hNormalizer");
  h_pPb13d->Rebin(2);
  TH1F* r_pPb13d = getRatio("r_pPb13d", h_pPb13d, h_pPbMC, n_pPb13d);

  TFile* f_pPb13e = new TFile(Form("%scsOutput/pPbOutput/Feb20AliPhysics/postQMNtuples/wEtaCorr/SMphiBin/PeriodByPeriod/fout_6_14bins_firstEvent0_13e_kEMCEGA_kINT7_kNonLinCorr_latestEMCalCorr_rpaName_StdCuts_EX0PurityFit_wEtaCorr_SMphiBinnoNorm.root", path.Data()), "READ");
  TH1F* h_pPb13e = (TH1F*)f_pPb13e->Get("hPhi");
  TH1D* n_pPb13e = (TH1D*)f_pPb13e->Get("hNormalizer");
  h_pPb13e->Rebin(2);
  TH1F* r_pPb13e = getRatio("r_pPb13e", h_pPb13e, h_pPbMC, n_pPb13e);

  TFile* f_pPb13f = new TFile(Form("%scsOutput/pPbOutput/Feb20AliPhysics/postQMNtuples/wEtaCorr/SMphiBin/PeriodByPeriod/fout_6_14bins_firstEvent0_13f_kEMCEGA_kINT7_kNonLinCorr_latestEMCalCorr_rpaName_StdCuts_EX0PurityFit_wEtaCorr_SMphiBinnoNorm.root", path.Data()), "READ");
  TH1F* h_pPb13f = (TH1F*)f_pPb13f->Get("hPhi");
  TH1D* n_pPb13f = (TH1D*)f_pPb13f->Get("hNormalizer");
  h_pPb13f->Rebin(2);
  TH1F* r_pPb13f = getRatio("r_pPb13f", h_pPb13f, h_pPbMC, n_pPb13f);

  TFile* f_pPb13fnew = new TFile(Form("%scsOutput/pPbOutput/Feb20AliPhysics/postQMNtuples/wEtaCorr/SMphiBin/PeriodByPeriod/fout_6_14bins_firstEvent0_13fnew_kEMCEGA_kINT7_kNonLinCorr_latestEMCalCorr_rpaName_StdCuts_EX0PurityFit_wEtaCorr_SMphiBinnoNorm.root", path.Data()), "READ");
  TH1F* h_pPb13fnew = (TH1F*)f_pPb13fnew->Get("hPhi");
  ...
  res_pPb13d->GetXaxis()->SetRangeUser(1, 3.5);
  res_pPb13d->SetTitle(";#phi;#frac{all pPb - 1 period}{all pPb}");
  ...
  TH1F* phiFactors_pPb = calcCorrectionFactor("phiFactors_pPb", r_pPb, "pPb");
  TH1F* phiFactors_pp = calcCorrectionFactor("phiFactors_pp", r_pp, "pp"); 
  printHistEntries(phiFactors_pPb);
  printHistEntries(phiFactors_pp);
  
  //p-Pb average
  TLine* line_pPb = new TLine(1, 0.0966356 , 3.5, 0.0966356);
  line_pPb->SetLineColor(kBlack);
  line_pPb->SetLineStyle(kDashed);
  line_pPb->SetLineWidth(2);

  //pp average
  TLine* line_pp = new TLine(1, 0.100581, 3.5, 0.100581);
  ...
  r_pp->GetXaxis()->SetRangeUser(1, 3.5);
  r_pPb->GetYaxis()->SetRangeUser(0, 0.15);
  r_pp->GetYaxis()->SetRangeUser(0, 0.15);
