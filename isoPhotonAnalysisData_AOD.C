...
void Run(ULong64_t TriggerBit, TString address, Long64_t firstEvent = 0, Long64_t lastEvent = 1000000000000000){
  ...
  auto hEG1woPurity_E = new TH1F("hEG1woPurity_E", "", nbinscluster, clusterbins);
  auto hEG2woPurity_E = new TH1F("hEG2woPurity_E", "", nbinscluster, clusterbins);
  ...
  auto hEG1woPurity_nonLinE = new TH1F("hEG1woPurity_nonLinE", "", nbinscluster, clusterbins);
  auto hEG2woPurity_nonLinE = new TH1F("hEG2woPurity_nonLinE", "", nbinscluster, clusterbins);
  ...
  TH1F* hEG1_Diff[5];
  TH1F* hEG2_Diff[5];
  TH1F* hEGA_DiffNoCuts = new TH1F("hEGA_DiffNoCuts", ";E_{T} ;counts", 2000, -100, 100);
  for(int i = 0 ; i < 5; i++){
    hEG1_Diff[i] = new TH1F(Form("hEG1_DiffBin%i",i), "", 2000, -100, 100);
    hEG2_Diff[i] = new TH1F(Form("hEG2_DiffBin%i",i), "", 2000, -100, 100);
  }
  hEG1_Diff[0]->SetTitle("Cluster Energy Difference EG1: 1 GeV < #gamma_{E_{raw}} < 5 GeV ;E_{T} ;counts");
  hEG1_Diff[1]->SetTitle("Cluster Energy Difference EG1: 5 GeV < #gamma_{E_{raw}} < 12 GeV ;E_{T} ;counts");
  hEG1_Diff[2]->SetTitle("Cluster Energy Difference EG1: 12 GeV < #gamma_{E_{raw}} < 20 GeV ;E_{T} ;counts");
  hEG1_Diff[3]->SetTitle("Cluster Energy Difference EG1: 20 GeV < #gamma_{E_{raw}} ;E_{T} ;counts");
  hEG2_Diff[0]->SetTitle("Cluster Energy Difference EG2: 1 GeV < #gamma_{E_{raw}} < 5 GeV ;E_{T} ;counts");
  hEG2_Diff[1]->SetTitle("Cluster Energy Difference EG2: 5 GeV < #gamma_{E_{raw}} < 12 GeV ;E_{T} ;counts");
  hEG2_Diff[2]->SetTitle("Cluster Energy Difference EG2: 12 GeV < #gamma_{E_{raw}} < 20 GeV ;E_{T} ;counts");
  hEG2_Diff[3]->SetTitle("Cluster Energy Difference EG2: 20 GeV < #gamma_{E_{raw}} ;E_{T} ;counts");
  ...
  hEG1_E->Sumw2();  
  hEG2_E->Sumw2();
  hEG1woPurity_E->Sumw2();  
  hEG2woPurity_E->Sumw2();
  hEG1_nonLinE->Sumw2();  
  hEG2_nonLinE->Sumw2();
  hEG1woPurity_nonLinE->Sumw2();  
  hEG2woPurity_nonLinE->Sumw2();
  hEventPerRun->Sumw2();
  hEG1woPvsRuns->Sumw2();
  ...
  hEG1woPurity_E->SetTitle("; E_{T} (GeV) ; 1/N_{ev}^{EG1}dN/dE_{T}");
  hEG2woPurity_E->SetTitle("; E_{T} (GeV) ; 1/N_{ev}^{EG2}dN/dE_{T}");
  hEG1_nonLinE->SetTitle("; E_{T} (GeV) ; 1/N_{ev}^{EG1}dN/dE_{T}");
  hEG2_nonLinE->SetTitle("; E_{T} (GeV) ; 1/N_{ev}^{EG2}dN/dE_{T}");
  hEG1woPurity_nonLinE->SetTitle("; E_{T} (GeV) ; 1/N_{ev}^{EG1}dN/dE_{T}");
  hEG2woPurity_nonLinE->SetTitle("; E_{T} (GeV) ; 1/N_{ev}^{EG2}dN/dE_{T}");
 ...
 //////////////////////////////////////////////////////////////////////////////////*/
  ...
  for (Long64_t ievent= firstEvent;ievent< numEntries ;ievent++) {
	...
	Float_t clusterPt_nonLinCorr = 0.0;
	Float_t clusterE_nonLinCorr = 0.0;
	Float_t clusterEta_nonLinCorr = 0.0;
	Float_t clusterPhi_nonLinCorr = 0.0;
	
	clusterPt_nonLinCorr = cluster_pt_nonLinCorr[n];
	clusterE_nonLinCorr = cluster_e_nonLinCorr[n];
	clusterEta_nonLinCorr = cluster_eta_nonLinCorr[n];
	clusterPhi_nonLinCorr = cluster_phi_nonLinCorr[n];

	hEGA_DiffNoCuts->Fill(clusterPt-clusterPt_nonLinCorr);
	...
	if(not ((cluster_tof[n] > timeCut*-1.0) && (cluster_tof[n] < timeCut))) continue;
	...
	if(TMath::Abs(cluster_eta_nonLinCorr[n]) < maxEta){
	  if((1.396 < cluster_phi_nonLinCorr[n]) && (cluster_phi_nonLinCorr[n] < 3.28)){
	    double purity = Get_Purity_ErrFunction(clusterPt_nonLinCorr, "");
	    if(isEG2) {
	      hEG2woPurity_nonLinE->Fill(clusterPt_nonLinCorr, 1);
	      hEG2_nonLinE->Fill(clusterPt_nonLinCorr, purity);
	    }
	    if(isEG1){
	      hEG1woPurity_nonLinE->Fill(clusterPt_nonLinCorr, 1);
	      hEG1_nonLinE->Fill(clusterPt_nonLinCorr, purity);
	    }
	  }//end nonLinPhi if
	}//end nonLinEta if
	//acceptance cuts
	if(not (TMath::Abs(cluster_eta[n]) < maxEta)) continue;
	...
	if(isEG2) {
	  ...
	  hEG2woPurity_E->Fill(clusterPt, 1);
	  hEG2_E->Fill(clusterPt, purity);
	  if(clusterPt > 1.0 && clusterPt < 5.0) hEG2_Diff[0]->Fill(clusterPt-clusterPt_nonLinCorr);
	  if(clusterPt > 5.0 && clusterPt < 12.0) hEG2_Diff[1]->Fill(clusterPt-clusterPt_nonLinCorr);
	  if(clusterPt > 12.0 && clusterPt < 20.0) hEG2_Diff[2]->Fill(clusterPt-clusterPt_nonLinCorr);
	  if(clusterPt > 20.0) hEG2_Diff[3]->Fill(clusterPt-clusterPt_nonLinCorr);
	  //hEG2woPurity_nonLinE->Fill(clusterPt, 1);
	  //hEG2_nonLinE->Fill(clusterPt, purity);
	}
	if(isEG1){
	  if(clusterPt > 5)
	    numClusterMoreThan5GeV++;
	  //cout << "ievent: " << ievent << "\tncluster: " << n << "\tp_{T}: " << clusterPt << endl;
	  hEG1woPurity_E->Fill(clusterPt, 1);
	  hEG1_E->Fill(clusterPt, purity);
	  if(clusterPt > 1.0 && clusterPt < 5.0) hEG1_Diff[0]->Fill(clusterPt-clusterPt_nonLinCorr);
	  if(clusterPt > 5.0 && clusterPt < 12.0) hEG1_Diff[1]->Fill(clusterPt-clusterPt_nonLinCorr);
	  if(clusterPt > 12.0 && clusterPt < 20.0) hEG1_Diff[2]->Fill(clusterPt-clusterPt_nonLinCorr);
	  if(clusterPt > 20.0) hEG1_Diff[3]->Fill(clusterPt-clusterPt_nonLinCorr);
	  //hEG1woPurity_nonLinE->Fill(clusterPt, 1);
	  //hEG1_nonLinE->Fill(clusterPt, purity);
...
//Writing to file
  filename += "_StdCuts_EX0PurityFit_ClusterEDiff_AOD_noNorm";
  cout << filename << endl;
  ...
  hEG1_E->Write("hEG1_E");
  hEG2_E->Write("hEG2_E");
  hEG1woPurity_E->Write("hEG1woPurity_E");
  hEG2woPurity_E->Write("hEG2woPurity_E");
  hEG1_nonLinE->Write("hEG1_nonLinE");
  hEG2_nonLinE->Write("hEG2_nonLinE");
  hEG1woPurity_nonLinE->Write("hEG1woPurity_nonLinE");
  hEG2woPurity_nonLinE->Write("hEG2woPurity_nonLinE");
  ...
  hEGA_DiffNoCuts->Write("hEGA_DiffNoCuts");
  hEG1_Diff[0]->Write("hEG1_Diff0");
  hEG1_Diff[1]->Write("hEG1_Diff1");
  hEG1_Diff[2]->Write("hEG1_Diff2");
  hEG1_Diff[3]->Write("hEG1_Diff3");
  hEG2_Diff[0]->Write("hEG2_Diff0");
  hEG2_Diff[1]->Write("hEG2_Diff1");
  hEG2_Diff[2]->Write("hEG2_Diff2");
  hEG2_Diff[3]->Write("hEG2_Diff3");
...
void isoPhotonAnalysisData_AOD(){
...
/////////////////////////////////////////////////////////////////*/
  ...
  //Run(6, "pPb/13e/13e_allRuns_wNonLinCorr_AlwinaNtuplizer_part00.root");
  //Run(6, "pPb/13e/13e_allRuns_wNonLinCorr_AlwinaNtuplizer_part01.root");
  //Run(6, "pPb/13f/13f_allRuns_wNonLinCorr_AlwinaNtuplizer_part00.root");
  //Run(6, "pPb/13f/13f_allRuns_wNonLinCorr_AlwinaNtuplizer_part01.root");
  //Run(6, "pPb/13f/13f_allRuns_wNonLinCorr_AlwinaNtuplizer_part02.root");
  //Run(6, "pPb/13f/13f_allRuns_wNonLinCorr_AlwinaNtuplizer_part03.root");
  //Run(6, "pPb/13f/13f_allRuns_wNonLinCorr_AlwinaNtuplizer_part04.root");

  //Run(6, "pPb/13f/13f_allRuns_woNonLinCorr_AlwinaNtuplizer_part00.root");
  //Run(6, "pPb/13f/13f_allRuns_woNonLinCorr_AlwinaNtuplizer_part01.root");
  //Run(6, "pPb/13f/13f_allRuns_woNonLinCorr_AlwinaNtuplizer_part02.root");
  //Run(6, "pPb/13f/13f_allRuns_woNonLinCorr_AlwinaNtuplizer_part03.root");
  //Run(6, "pPb/13f/13f_allRuns_woNonLinCorr_AlwinaNtuplizer_part04.root");
